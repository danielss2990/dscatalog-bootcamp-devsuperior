                            ...
                            <Image source={menu} />
                            {
                                show ? (
                                    <View style={nav.options}>
                                        ...
                                        <TouchableOpacity activeOpacity={0.8} style={nav.option} onPress={() => navigate("Home")}>
                                            <Text style={[nav.textOption, route.name == "Home" ? nav.textActive : null,
                                            ]}>Home</Text>
                                        </TouchableOpacity>

                                        <TouchableOpacity activeOpacity={0.8} style={nav.option} onPress={() => navigate("Catalog")}>
                                            <Text style={[nav.textOption, route.name == "Catalog" ? nav.textActive : null,
                                            ]}>Catálogo</Text>
                                        </TouchableOpacity>

                                        <TouchableOpacity activeOpacity={0.8} style={nav.option} onPress={() => navigate("Login")}>
